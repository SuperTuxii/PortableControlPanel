...
RowLayout {
    ...
    readonly property var structure: {
        ...
        "Size and Position": [
            { text: "Position", value: Connection.X },
            { text: "Size", value: Connection.Width },
            { text: "Min Size", value: Connection.MinWidth },
            { text: "Max Size", value: Connection.MaxWidth },
            { text: "Length", value: Connection.Length },
        ],
    }
